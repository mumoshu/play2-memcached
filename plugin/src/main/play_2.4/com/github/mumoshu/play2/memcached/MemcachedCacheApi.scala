...
@Singleton
class MemcachedCacheApi @Inject() (val namespace: String, client: MemcachedClient, configuration: play.api.Configuration) extends CacheApi {
  val conf = com.github.mumoshu.play2.memcached.Configuration(configuration)
